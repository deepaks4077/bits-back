...
if __name__ == '__main__':
    ...
    model = BetaBinomialVAE(200, 50).to(device)
    ...
    recon_dataset = datasets.MNIST('Datasets/mnist', train=False, download=True,
    ...
    torch.save(model.state_dict(), 'OriginalParameters/torch_vae_beta_binomial_params_new')
